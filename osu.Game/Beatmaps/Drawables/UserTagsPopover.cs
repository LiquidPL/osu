...
{
    public partial class UserTagsPopover : OsuPopover
    {
        ...
        public readonly BindableDictionary<long, bool> ActiveTags = new BindableDictionary<long, bool>();

        public Action<UserTag>? OnSelected { get; set; }

        private CancellationTokenSource? loadCancellationTokenSource;

        public UserTagsPopover()
        ...
        private IEnumerable<Drawable> createItems(IEnumerable<UserTag> tags)
        {
            ...
            foreach (var group in grouped)
            {
                ...
                foreach (var tag in group.OrderBy(t => t.FullName))
                    drawableGroup.Add(new DrawableAddableTag(tag) { Active = { BindTarget = ActiveTags.Values. }, Action = () => OnSelected?.Invoke(tag) });
        ...
        private partial class DrawableAddableTag : OsuAnimatedButton, IFilterable
        {
            ...
            public readonly Bindable<bool> Active = new Bindable<bool>();
