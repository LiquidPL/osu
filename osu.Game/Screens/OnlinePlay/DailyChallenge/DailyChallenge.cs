...
namespace osu.Game.Screens.OnlinePlay.DailyChallenge
{
    public partial class DailyChallenge : OsuScreen, IPreviewTrackOwner, IHandlePresentBeatmap
    {
        ...
        private PlayFooterButton playFooterButton = null!;
        ...
        public override void FooterArriving()
        {
            ...
            playFooterButton.OnLoadComplete += _ => playFooterButton.Appear();
        ...
        public override void FooterExiting()
        {
            ...
            playFooterButton.Disappear().Expire();
        }
        ...
        protected override IReadOnlyList<Drawable> CreateFooterContent()
        {
            ...
            content.Add(playFooterButton = new PlayFooterButton
            {
        ...
        private void userModSelectStateChanged(ValueChangedEvent<Visibility> state)
        {
            if (state.NewValue == Visibility.Visible)
                playFooterButton.Disappear();
            else
                playFooterButton.Appear();
        }
