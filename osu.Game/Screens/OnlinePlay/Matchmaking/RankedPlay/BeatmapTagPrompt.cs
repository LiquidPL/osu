...
namespace osu.Game.Screens.OnlinePlay.Matchmaking.RankedPlay
{
    public partial class BeatmapTagPrompt : CompositeDrawable
    {
                ...
                new FillFlowContainer
                {
                    ...
                    Children = new Drawable[]
                    {
                        ...
                        beatmapCardContainer = new Container
                        {
                            ...
                            // Child = new MatchmakingSelectPanel.CardContentBeatmap(beatmap, []),
                        },
                        new UserTagControl(beatmap)
                        {
                            ...
                            Margin = new MarginPadding { Bottom = 10 },
                            Writable = true,
                            Filter = t => t.FullName.StartsWith("skillset", StringComparison.Ordinal),
                        },
                        new OsuSpriteText
                        {
        ...
        private async Task fetchBeatmap()
        {
            ...
            Logger.Log($"{apiBeatmap.OnlineID}");
